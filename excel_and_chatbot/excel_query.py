...
class ExcelQueryHandler:
    ...
    def _load_excel(self):
        ...
        try:
            ...
            for col in self.df.columns:
                ...
                elif any(k in col_lower for k in ["tên", "ten", "kcn", "ccn"]):
    ...
    # ==========================================================
    def format_table_response(self, df: pd.DataFrame, province_name: str) -> str:
        """(Tuỳ chọn) Hiển thị kết quả dạng bảng text"""
        if df is None or df.empty:
            return f"Không tìm thấy thông tin tại {province_name}."
...
if __name__ == "__main__":
    ...
    for query in test_queries:
        ...
        if handled:
            ...
            print("⏭️ Bỏ qua - Không phải câu hỏi liệt kê KCN/CCN")
        print("-" * 80)
